...
namespace molecula_shared
{
    ...
    {//mainly to make sure to not "harm" PubChem 
     ...
     //No longer than 300 second running time per minute.
        ...
        //const string BasePubChemUri = "https://pubchem.ncbi.nlm.nih.gov/rest/pug/compound/";
        ...
        //    var start = DateTime.Now;
        //    await Wait(start);
        //    var httpRequest = (HttpWebRequest)WebRequest.Create(string.Concat(BasePubChemUri, requestUrl));
